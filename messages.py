...
class RecordMessage(Message):
    ...
    def __init__(self, stream, record, version=None, time_extracted=None, repo_path=None):
        self.stream = stream
        self.record = record
...
def write_record(stream_name, record, stream_alias=None, time_extracted=None, repo_path=None):

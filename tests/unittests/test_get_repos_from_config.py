...
class TestGetReposFromConfig(unittest.TestCase):
    ...
    def test_should_get_repos_from_org_with_include(self, mocked_get_all_repositories):
        config = {
            "organization": "org",
            "repos_include": "repo1 repo2 org/repo3"
        }
    ...
    @mock.patch("tap_github.__init__.get_all_repositories")
    def test_should_get_repos_from_org_with_include_and_ignore_exclude(self, mocked_get_all_repositories):
        config = {
            "organization": "org",
            "repos_include": "repo1 repo2 org/repo3",
            "repos_exclude": "repo1 repo2 repo3"
        }
    ...
    @mock.patch("tap_github.__init__.get_all_repositories")
    def test_should_get_repos_from_org_with_repository_and_ignore_exclude(self, mocked_get_all_repositories):
        config = {
            "organization": "org",

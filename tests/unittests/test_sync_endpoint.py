...
class TestSyncEndpoints(unittest.TestCase):
    ...
    def test_sync_without_state(self, mock_write_records, mock_authed_all_pages, mock_verify_access, mock_get_schema):
        ...
        mock_authed_all_pages.assert_called_with(mock.ANY, 'https://api.github.com/repos/tap-github/events', mock.ANY, 'events', True)
...
class TestFullTable(unittest.TestCase):
    ...
    def test_without_child_stream(self, mock_get_child_records, mock_authed_get_all_pages, mock_verify_access, mock_get_schema):
        ...
        mock_authed_get_all_pages.assert_called_with(mock.ANY, "https://api.github.com/repos/tap-github/stargazers", mock.ANY, 'stargazers', True)
    ...
    def test_with_child_streams(self,  mock_get_child_records, mock_authed_get_all_pages, mock_verify_access, mock_get_schema):
        ...
        # Verify that the authed_get_all_pages() is called with the expected url
        mock_authed_get_all_pages.assert_called_with(mock.ANY, "https://api.github.com/orgs/tap-github/teams", mock.ANY, 'teams', True)
    ...
    def test_with_nested_child_streams(self, mock_authed_get_all_pages, mock_verify_access, mock_get_schema):
        ...
        # Verify that the authed_get_all_pages() is called with the expected url
        exp_call_1 = mock.call(mock.ANY, "https://api.github.com/orgs/tap-github/teams", mock.ANY, 'teams', True)
        exp_call_2 = mock.call(mock.ANY, "https://api.github.com/orgs/tap-github/teams/stitch-dev/members", {}, 'team_members', True)
        exp_call_3 = mock.call(mock.ANY, "https://api.github.com/orgs/tap-github/teams/stitch-dev/memberships/log1", {}, 'team_memberships', True)
...
class TestIncrementalStream(unittest.TestCase):
    ...
    def test_without_child_stream(self, mock_get_child_records, mock_authed_get_all_pages, mock_verify_access, mock_get_schema):
        ...
        # Verify that the authed_get_all_pages() is called with the expected url
        mock_authed_get_all_pages.assert_called_with(mock.ANY, "https://api.github.com/repos/tap-github/commits?since=", mock.ANY, 'commits', True)
    ...
    def test_with_child_streams(self,  mock_get_child_records, mock_authed_get_all_pages, mock_verify_access, mock_get_schema):
        ...
        # Verify that the authed_get_all_pages() is called with the expected url
        mock_authed_get_all_pages.assert_called_with(mock.ANY, "https://api.github.com/repos/tap-github/projects?state=all", mock.ANY, 'projects', True)
    ...
    def test_with_nested_child_streams(self, mock_authed_get_all_pages, mock_verify_access, mock_get_schema):
        ...
        exp_call_1 = mock.call(mock.ANY, "https://api.github.com/repos/tap-github/projects?state=all", mock.ANY, 'projects', True)
        exp_call_2 = mock.call(mock.ANY, "https://api.github.com/projects/1/columns", {}, 'project_columns', True)
        exp_call_3 = mock.call(mock.ANY, "https://api.github.com/projects/columns/1/cards", {}, 'project_cards', True)
...
class TestIncrementalOrderedStream(unittest.TestCase):
    ...
    def test_without_child_stream(self, mock_get_child_records, mock_strptime_to_utc, mock_authed_get_all_pages, mock_verify_access, mock_get_schema):
        ...
        # Verify that the authed_get_all_pages() is called with the expected url
        mock_authed_get_all_pages.assert_called_with(mock.ANY, "https://api.github.com/repos/tap-github/pulls?state=all&sort=updated&direction=desc", {}, 'pull_requests', True)
    ...
    def test_with_nested_child_streams(self, mock_strptime_to_utc, mock_authed_get_all_pages, mock_verify_access, mock_get_schema):
        ...
        exp_call_1 = mock.call(mock.ANY, "https://api.github.com/repos/tap-github/pulls?state=all&sort=updated&direction=desc", {}, 'pull_requests', True)
        exp_call_2 = mock.call(mock.ANY, "https://api.github.com/repos/tap-github/pulls/1/comments?sort=updated_at&direction=desc", {}, 'review_comments', True)
